...
/**
 * "Push this device's edited/created cards to the backend" button, rendered
 * inline in every page's header next to the user menu — cards are no longer
 * synced automatically, so this is the only way edits made this session
